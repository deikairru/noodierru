...
export function CTA() {
  return (
    <div className="w-screen bg-slate-50 pb-24">
      <div className="cta w-4/5 h-[200px] md:h-[300px] relative bg-slate-600 bg-[url('https://images.unsplash.com/photo-1569058242567-93de6f36f8e6')] bg-cover mt-12 mx-auto rounded-2xl overflow-hidden select-none">
